...
export type AppSection = "about" | "education" | "advanced" | "library";

const normalizePath = (path: string) =>
  path !== "/" && path.endsWith("/") ? path.slice(0, -1) : path;

export const mainNavigationConfig: NavItemConfig[] = [
  { id: 1, path: "/", titleKey: "header.navs.nav1" },
...
export const sidebarNavigationConfig: Record<AppSection, NavItemConfig[]> = {
  about: [
    ...
    { id: 7, path: "/about/union", titleKey: "sidebar.union" },
    {
      ...
      titleKey: "sidebar.qualitySystem",
    },
  ...
  education: [
    ...
    { id: 2, path: "/education/spo", titleKey: "sidebar.education.spo" },
    {
      ...
      titleKey: "sidebar.education.bakalavr",
    },
    {
      id: 4,
      path: "/education/magistr",
      titleKey: "sidebar.education.magistr",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      titleKey: "sidebar.education.kafedgmu",
    },
    {
      id: 8,
      path: "/education/kafedem",
      titleKey: "sidebar.education.kafedem",
    },
    {
      id: 9,
      path: "/education/kafedbp",
      titleKey: "sidebar.education.kafedbp",
    },
    {
      id: 10,
      path: "/education/anket",
      titleKey: "sidebar.education.anket",
    },
  ],
  advanced: [
    { id: 1, path: "/advanced", titleKey: "sidebar.advanced.about" },
    {
      ...
      titleKey: "sidebar.advanced.profDevelop",
    },
    {
      id: 3,
      path: "/advanced/employees",
      titleKey: "sidebar.advanced.employees",
    },
  ],
  library: [
    ...
    {
      id: 2,
      path: "/library/new-arrive",
      titleKey: "sidebar.library.newArrivals",
    },
    {
      id: 3,
      path: "/library/journals",
      titleKey: "sidebar.library.electronicJournals",
    },
    {
      id: 4,
      path: "/library/e-book",
      titleKey: "sidebar.library.electronicBooks",
    },
    {
      id: 5,
      path: "/library/research",
      titleKey: "sidebar.library.departments",
    },
    {
      id: 6,
      path: "/library/samd",
      titleKey: "sidebar.library.SAMDepartment",
    },
